...
const Decoration = () => {
    return (
        <div className='flex flex-col lg:flex-row justify-between items-center gap-10 p-10 bg-gradient-to-b lg:bg-gradient-to-r from-green-100 via-green-200 to-green-300 rounded-2xl my-20'>
            <div>
                <h1 className='lg:text-left text-center text-5xl font-bold text-green-950'>Eco Decoration Ideas</h1>
            ...
            <div className='grid grid-cols-2 gap-10 lg:w-1/2'>
                <img className='w-[300px] rounded-xl mx-auto' src="https://i.ibb.co.com/cc6KTt3k/decoration1.png" alt="Decoration Image" />
                <img className='w-[300px] rounded-xl mx-auto' src="https://i.ibb.co.com/BVKzJZtQ/decoration2.png" alt="Decoration Image" />
                <img className='w-[300px] rounded-xl mx-auto' src="https://i.ibb.co.com/7tvvq3hb/decoration3.png" alt="Decoration Image" />
                <img className='w-[300px] rounded-xl mx-auto' src="https://i.ibb.co.com/DHZ1b9BK/decoration4.png" alt="Decoration Image" />
            </div>
        </div>
    );
};
